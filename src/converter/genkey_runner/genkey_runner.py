...
# output_path = Path(
#     "/Users/quang-dang/Documents/viet-corpus-converter/corpus-json-combiner/data/input/test_batch1/"
# )
#
# input_path = Path(
#     "/Users/quang-dang/Documents/viet-corpus-converter/telex-converter/data/output/batch1/"
# )
...
def run_genkey(file_list: list, output_path: Path, genkey_folder_path: Path) -> list:
    output_files = []
    genkey_executable = genkey_folder_path / "genkey"
