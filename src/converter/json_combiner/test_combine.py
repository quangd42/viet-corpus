...
from .combine import combine_all_json, combine_two_json
...
corpus4 = {
    'letters': {'a': 6, 'b': 14, 'f': 12, 'd': 20, 'c': 6},
    'bigrams': {'ab': 4},
    'trigrams': {'the': 4},
    'toptrigrams': [
        {'Ngram': 'right', 'Count': 20},
        {'Ngram': 'you', 'Count': 16},
        {'Ngram': 'the', 'Count': 6},
        {'Ngram': 'man', 'Count': 2},
    ],
